...
class N2RulesScreen extends ConsumerStatefulWidget {
  const N2RulesScreen({super.key});

  @override
  ConsumerState<N2RulesScreen> createState() => _N2RulesScreenState();
}

class _N2RulesScreenState extends ConsumerState<N2RulesScreen> {
  @override
  void initState() {
    super.initState();
            ...
            Expanded(
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    _StepItem(number: 1, text: AppStrings.n2Step1),
                    const SizedBox(height: 16),
                    _StepItem(number: 2, text: AppStrings.n2Step2),
                    const SizedBox(height: 16),
                    _StepItem(number: 3, text: AppStrings.n2Step3),
                    const SizedBox(height: 16),
                    _StepItem(number: 4, text: AppStrings.n2Step4),
